...
class Functions:
    ...
    def compare(self, dirs1, dirs2, T1):
        T1.configure(state="normal")
        ...
        buttonComp2 = Button(root, text='Compare', command=lambda: func.compare(dirs1, dirs2, T1))
...
buttonComp = Button(root, text='Compare', command=lambda: func.compare(dirs1, dirs2, T1))
